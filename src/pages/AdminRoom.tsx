...
export const AdminRoom = () => {
  ...
  return (
    <>
      ...
      <div className='min-h-screen pb-4 dark:bg-shadow' id='admin' >
        ...
        <Modal
          ...
          className='flex flex-col gap-4 h-80 w-full md:w-3/5 lg:w-2/5 rounded-lg bg-white-background dark:bg-black bg-opacity- justify-center items-center'
        >
          ...
          <h1 className='font-poppins font-bold text-2xl text-black dark:text-white'>Delete question</h1>
          <p className='font-roboto text-gray-dark dark:text-gray-light'>Are you sure you want to remove this question?</p>
        ...
        <main className='max-w-3xl mx-auto'>
          <div className='mt-8 mb-6 flex flex-col gap-4 md:gap-0 md:flex-row items-center'>
            <h1 className='font-poppins text-center sm:text-left text-2xl text-black dark:text-white'>Room {title}</h1>
            {questions.length > 0 &&
